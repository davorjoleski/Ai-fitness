      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            Calculate your BMI, daily calorie needs, and macro targets
          </p>
        </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl p-6">
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">Body Mass Index (BMI)</h4>
                  <div className="flex items-center justify-between">
                    <span className="text-3xl font-bold text-gray-900">{results.bmi.toFixed(1)}</span>
                    <span className={`font-semibold ${getBMICategory(results.bmi).color}`}>
                ...
                {/* Daily Calories */}
                <div className="bg-white rounded-xl p-6">
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">Daily Calories</h4>
                ...
                {/* Macros */}
                <div className="bg-white rounded-xl p-6">
                  <h4 className="text-lg font-semibold text-gray-900 mb-4">Daily Macros</h4>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-700">Protein</span>
                      <span className="font-semibold text-blue-600">{results.macros.protein}g</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-700">Carbs</span>
                      <span className="font-semibold text-green-600">{results.macros.carbs}g</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-700">Fats</span>
                      <span className="font-semibold text-yellow-600">{results.macros.fats}g</span>
                    </div>
                  </div>
                </div>
              </div>

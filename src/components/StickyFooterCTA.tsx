        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
          <div className="flex items-center justify-between gap-4">
            <div className="flex-1 min-w-0">
              <p className={`text-base sm:text-lg font-semibold leading-tight ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
            ...
            <div className="flex items-center space-x-3 flex-shrink-0">
              <button
                ...
                className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-3 px-4 sm:px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center text-sm sm:text-base whitespace-nowrap"
              >
